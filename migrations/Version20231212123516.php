 ...
 */
final class Version20231212123516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account ADD role_id INT NOT NULL, DROP role');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account ADD role VARCHAR(50) NOT NULL, DROP role_id');
    }
}
